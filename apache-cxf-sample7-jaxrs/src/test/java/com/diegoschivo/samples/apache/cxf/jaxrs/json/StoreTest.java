...
package com.diegoschivo.samples.apache.cxf.jaxrs.json;
...
public class StoreTest
{
    ...
    public void testGet() throws Exception
    {
        ...
        try
        {
            ...
            assertEquals(
                "FOO",
                StringUtils.substringBetween(EntityUtils.toString(response.getEntity()), "\"code\":\"", "\""));
        }
        finally
        {
    ...
    public void testAddProduct() throws Exception
    {
        ...
        request.setEntity(new StringEntity(
            "{\"Product\":{\"code\":\"BAR\",\"name\":\"Dolor sit amet\"}}",
        ...
        try
        {
            HttpResponse response = httpClient.execute(request);
            assertEquals(HttpStatus.SC_OK, response.getStatusLine().getStatusCode());
            assertEquals("2", StringUtils.substring(
                StringUtils.substringAfter(EntityUtils.toString(response.getEntity()), "\"id\":"),
                0,
                1));
        }
        finally
    ...
    public void testUpdateProduct() throws Exception
    {
        ...
        request.setEntity(new StringEntity(
            "{\"Product\":{\"id\":\"1\",\"code\":\"BAR\",\"name\":\"Dolor sit amet\"}}",
            ContentType.APPLICATION_JSON));
        DefaultHttpClient httpClient = new DefaultHttpClient();
        try
        {
    ...
    public void testUpdateUnexistingProduct() throws Exception
    {
        HttpPut request = new HttpPut(BASE_SERVICE_URL);
        request.setEntity(new StringEntity(
            "{\"Product\":{\"id\":\"2\",\"code\":\"BAR\",\"name\":\"Dolor sit amet\"}}",
            ContentType.APPLICATION_JSON));
        DefaultHttpClient httpClient = new DefaultHttpClient();
        try
        {
